...
export const postDonation = async(data) => {
    const {donorName,donationQuality,donationQuantity,donorPhone,donorLocation,donorDesc} = data;

    try {
        const res = await fetch(`/food-donation`,{
            method:'POST',
            headers:{
                "Content-Type":'application/json'
            },
            body:JSON.stringify({
                name:donorName,quality:donationQuality,quantity:donationQuantity,phone:donorPhone,location:donorLocation,description:donorDesc
            })
        })
...
export const postRequest = async(data) => {
    const {requestName,requestQuality,requestQuantity,requestPhone,requestLocation,requestDesc} = data;

    try {
        const res = await fetch(`/food-requests`,{
            method:'POST',
            headers:{
                "Content-Type":'application/json'
            },
            body:JSON.stringify({
                name:requestName,quality:requestQuality,quantity:requestQuantity,phone:requestPhone,location:requestLocation,description:requestDesc
            })
        })
...
export function proactiveness(self_life,distance) {
